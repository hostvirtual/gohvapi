...
### <a name="Client.GetLocations">func</a> (\*Client) [GetLocations](/src/target/locations.go?s=102:153#L1)
``` go
...
## <a name="Location">type</a> [Location](/src/target/locations.go?s=17:100#L1)
``` go
